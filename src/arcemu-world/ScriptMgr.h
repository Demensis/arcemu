...
class SERVER_DECL CreatureAIScript
{
	public:
		...
		virtual void OnQuestgiverHello(Player * mTarget) {}		virtual void GameEventStart(uint32 id) {}		virtual void GameEventFinish(uint32 id) {}		void RegisterAIUpdateEvent(uint32 frequency);
